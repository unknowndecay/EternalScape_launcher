...
cp native/build-x64/src/Release/EternalScape.exe build/win-x64/
cp target/EternalScape.jar build/win-x64/
...
echo EternalScape.exe 64bit sha256sum
sha256sum build/win-x64/EternalScape.exe

dumpbin //HEADERS build/win-x64/EternalScape.exe
