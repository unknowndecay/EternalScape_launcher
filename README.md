...
This repository holds the launcher for the [EternalScape client](https://github.com/runelite/runelite).
...
EternalScape is [licensed under the BSD 2-clause license](https://github.com/runelite/launcher/blob/master/LICENSE).
