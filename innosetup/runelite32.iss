...
OutputDir=${basedir}
OutputBaseFilename=EternalScapeSetup32

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-x86\EternalScape.exe"; DestDir: "{app}"
Source: "${basedir}\build\win-x86\EternalScape.jar"; DestDir: "{app}"
